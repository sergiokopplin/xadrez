...
describe("Validations", () => {
  describe("Moves", () => {
    test("isVerticalMove", () => {
      verticalMoves.forEach((move) =>
        expect(isVerticalMove(move[0], move[1])).toBe(true)
      );
      horizontalMoves.forEach((move) =>
        expect(isVerticalMove(move[0], move[1])).toBe(false)
      );
    ...
    test("isHorizontalMove", () => {
      verticalMoves.forEach((move) =>
        expect(isHorizontalMove(move[0], move[1])).toBe(false)
      );
      horizontalMoves.forEach((move) =>
        expect(isHorizontalMove(move[0], move[1])).toBe(true)
      );
      diagonalMoves.forEach((move) =>
        expect(isHorizontalMove(move[0], move[1])).toBe(false)
      );
    ...
    test("isDiagonalMove()", () => {
      verticalMoves.forEach((move) =>
        expect(isDiagonalMove(move[0], move[1])).toBe(false)
      );
      horizontalMoves.forEach((move) =>
        expect(isDiagonalMove(move[0], move[1])).toBe(false)
      );
      diagonalMoves.forEach((move) =>
        expect(isDiagonalMove(move[0], move[1])).toBe(true)
      );
    });
  });
  ...
  describe("Move Length", () => {
    test("isMoreThanSingleSquare()", () => {
      expect(
        isMoreThanSingleSquare(verticalMoves[0][0], verticalMoves[0][1])
      ).toBe(true);
      expect(
        isMoreThanSingleSquare(verticalMoves[1][0], verticalMoves[1][1])
      ).toBe(false);
      expect(
        isMoreThanSingleSquare(verticalMoves[2][0], verticalMoves[2][1])
      ).toBe(false);
      expect(
        isMoreThanSingleSquare(verticalMoves[3][0], verticalMoves[3][1])
      ).toBe(true);

      expect(
        isMoreThanSingleSquare(horizontalMoves[0][0], horizontalMoves[0][1])
      ).toBe(true);
      expect(
        isMoreThanSingleSquare(horizontalMoves[1][0], horizontalMoves[1][1])
      ).toBe(false);
      expect(
        isMoreThanSingleSquare(horizontalMoves[2][0], horizontalMoves[2][1])
      ).toBe(false);
      expect(
        isMoreThanSingleSquare(horizontalMoves[3][0], horizontalMoves[3][1])
      ).toBe(true);

      expect(
        isMoreThanSingleSquare(diagonalMoves[0][0], diagonalMoves[0][1])
      ).toBe(false);
      expect(
        isMoreThanSingleSquare(diagonalMoves[1][0], diagonalMoves[1][1])
      ).toBe(true);
      expect(
        isMoreThanSingleSquare(diagonalMoves[2][0], diagonalMoves[2][1])
      ).toBe(false);
      expect(
        isMoreThanSingleSquare(diagonalMoves[3][0], diagonalMoves[3][1])
      ).toBe(true);
      expect(
        isMoreThanSingleSquare(diagonalMoves[4][0], diagonalMoves[4][1])
      ).toBe(false);
      expect(
        isMoreThanSingleSquare(diagonalMoves[5][0], diagonalMoves[5][1])
      ).toBe(true);
      expect(
        isMoreThanSingleSquare(diagonalMoves[6][0], diagonalMoves[6][1])
      ).toBe(false);
      expect(
        isMoreThanSingleSquare(diagonalMoves[7][0], diagonalMoves[7][1])
      ).toBe(true);
    });
  });
